...
const CITIES = [
  ...
  { slug: 'new-york-city', name: 'New York City', state: 'NY', metro: '19.8M', sectors: 'finance, tech, media, healthcare', region: 'Northeast' },
  { slug: 'boston', name: 'Boston', state: 'MA', metro: '4.9M', sectors: 'biotech, finance, education, healthcare', region: 'Northeast' },
  { slug: 'san-francisco', name: 'San Francisco', state: 'CA', metro: '4.7M', sectors: 'tech, finance, biotech, tourism', region: 'West' },
  { slug: 'san-diego', name: 'San Diego', state: 'CA', metro: '3.3M', sectors: 'defense, biotech, tech, tourism', region: 'West' },
  { slug: 'detroit', name: 'Detroit', state: 'MI', metro: '4.3M', sectors: 'automotive, manufacturing, healthcare, tech', region: 'Midwest' },
  { slug: 'portland', name: 'Portland', state: 'OR', metro: '2.5M', sectors: 'tech, manufacturing, sustainability, food', region: 'Pacific Northwest' },
  { slug: 'las-vegas', name: 'Las Vegas', state: 'NV', metro: '2.3M', sectors: 'hospitality, entertainment, construction, logistics', region: 'Southwest' },
  { slug: 'st-louis', name: 'St. Louis', state: 'MO', metro: '2.8M', sectors: 'healthcare, finance, manufacturing, logistics', region: 'Midwest' },
  { slug: 'kansas-city', name: 'Kansas City', state: 'MO', metro: '2.2M', sectors: 'logistics, agriculture, tech, healthcare', region: 'Midwest' },
  { slug: 'columbus', name: 'Columbus', state: 'OH', metro: '2.1M', sectors: 'finance, education, tech, healthcare', region: 'Midwest' },
  { slug: 'indianapolis', name: 'Indianapolis', state: 'IN', metro: '2.1M', sectors: 'motorsports, logistics, pharma, manufacturing', region: 'Midwest' },
  { slug: 'cincinnati', name: 'Cincinnati', state: 'OH', metro: '2.2M', sectors: 'manufacturing, finance, healthcare, logistics', region: 'Midwest' },
  { slug: 'pittsburgh', name: 'Pittsburgh', state: 'PA', metro: '2.4M', sectors: 'healthcare, tech, education, manufacturing', region: 'Northeast' },
  { slug: 'sacramento', name: 'Sacramento', state: 'CA', metro: '2.4M', sectors: 'government, healthcare, agriculture, tech', region: 'West' },
  { slug: 'orlando', name: 'Orlando', state: 'FL', metro: '2.7M', sectors: 'hospitality, tech, healthcare, defense', region: 'Southeast' },
  { slug: 'raleigh', name: 'Raleigh', state: 'NC', metro: '1.4M', sectors: 'tech, biotech, education, government', region: 'Southeast' },
  { slug: 'salt-lake-city', name: 'Salt Lake City', state: 'UT', metro: '1.3M', sectors: 'tech, finance, outdoor recreation, healthcare', region: 'Mountain West' },
  { slug: 'jacksonville', name: 'Jacksonville', state: 'FL', metro: '1.6M', sectors: 'logistics, finance, healthcare, defense', region: 'Southeast' },
  { slug: 'memphis', name: 'Memphis', state: 'TN', metro: '1.3M', sectors: 'logistics, healthcare, manufacturing, agriculture', region: 'South' },
  { slug: 'milwaukee', name: 'Milwaukee', state: 'WI', metro: '1.6M', sectors: 'manufacturing, healthcare, finance, brewing', region: 'Midwest' },
  { slug: 'oklahoma-city', name: 'Oklahoma City', state: 'OK', metro: '1.4M', sectors: 'energy, aerospace, agriculture, healthcare', region: 'South' },
  { slug: 'richmond', name: 'Richmond', state: 'VA', metro: '1.3M', sectors: 'finance, government, manufacturing, healthcare', region: 'Southeast' },
  { slug: 'hartford', name: 'Hartford', state: 'CT', metro: '1.2M', sectors: 'insurance, finance, aerospace, healthcare', region: 'Northeast' },
  { slug: 'new-orleans', name: 'New Orleans', state: 'LA', metro: '1.3M', sectors: 'energy, hospitality, shipping, healthcare', region: 'South' },
  { slug: 'birmingham', name: 'Birmingham', state: 'AL', metro: '1.1M', sectors: 'healthcare, finance, manufacturing, construction', region: 'Southeast' },
];
