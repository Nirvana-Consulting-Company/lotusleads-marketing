    ...
    <div class="flex items-center justify-between h-16">
      ...
      <a href="/" class="flex items-center gap-2 shrink-0">
        <div class="w-9 h-9 rounded-lg bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center">
          <svg class="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C10.5 5.5 10 9 10 12.5S10.5 19 12 22c1.5-3 2-6.5 2-9.5S13.5 5.5 12 2z" opacity=".9"/><path d="M7 5.5C6 9 6.3 12 8 15.5c.8-3.5 1-7 .5-10.5C8 5 7.5 5.2 7 5.5z" opacity=".75"/><path d="M17 5.5c1 3.5.7 6.5-1 10 -.8-3.5-1-7-.5-10.5.5-.3 1-.5 1.5-.5z" opacity=".75"/><path d="M4 10c-.3 3 .5 6 2.5 8.5.2-3 0-6-.8-9C5 9.3 4.5 9.6 4 10z" opacity=".6"/><path d="M20 10c.3 3-.5 6-2.5 8.5-.2-3 0-6 .8-9 .6-.2 1.1.1 1.7.5z" opacity=".6"/></svg>
        </div>
        <span class="text-xl font-bold text-gray-900 tracking-tight">LotusLeads</span>
      </a>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-10">
      ...
      <div class="col-span-2 md:col-span-1">
        <a href="/" class="flex items-center gap-2 mb-4">
          ...
          <span class="text-lg font-bold text-white tracking-tight">LotusLeads</span>
        </a>
